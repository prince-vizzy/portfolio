...
const TitanicDashboard = ({ onOpenCV }) => {
  ...
  const chartDetails = {
    c1: {
      ...
      description: "Chi-square analysis showing significant survival disparity between genders (Ï‡Â² = 260.7, p < 0.001). Female passengers had a 74.2% survival rate compared to 18.9% for males, supporting the 'women and children first' protocol.",
      stats: { chi2: "260.7", p_value: "< 0.001", insight: "Gender was the strongest predictor of survival" }
    },
    c2: {
      title: "Survival by Class",
      description: "Social class strongly influenced survival chances (Ï‡Â² = 102.9, p < 0.001). First-class passengers had a 63.0% survival rate, while third-class only had 24.2%, highlighting socioeconomic disparities in the disaster.",
    ...
    c7: {
      ...
      description: "Survivors paid significantly higher fares (Â£48.40 avg vs Â£22.12), a 119% premium. Higher fares (1st/2nd class) provided better access to lifeboats, though fare itself correlates strongly with class.",
      stats: { survivors: "Â£48.40", perished: "Â£22.12", insight: "119% fare premium for survivors" }
    },
    c8: {
  ...
  useEffect(() => {
    ...
    if (chart7Ref.current) {
      chart7Instance.current = new Chart(chart7Ref.current, {
        type: 'bar',
        data: {
          labels: ['Â£0â€“10', 'Â£11â€“25', 'Â£26â€“50', 'Â£51â€“100', 'Â£100+'],
          datasets: [
    ...
    <>
        ...
        <div className="titanic-container">
          ...
          <div className="dashboard-header">
            <div>
              ...
              <span className="dashboard-subtitle">RMS Titanic Â· April 1912 Â· N = 891 passengers</span>
            </div>
          ...
          <div className="charts-row-2">
            {[
              { id: 'c4', title: 'Sex Ã— class interaction â€” survival rate (%)', subtitle: 'H3: protocol attenuated in 3rd class Â· female drop 96.8% â†’ 50.0%', legend: [['#1D9E75','female'],['#D85A30','male']], ref: chart4Ref },
              { id: 'c5', title: 'Family composition', subtitle: 'H5: inverted-U Â· small family best', legend: [['#D85A30','alone'],['#1D9E75','small'],['#888780','large']], ref: chart5Ref },
          ...
          <div className="charts-row-3">
            {[
              { id: 'c7', title: 'Fare distribution by survival', subtitle: 'H4: survivors paid Â£48.40 avg vs Â£22.12 â€” 119% premium Â· log transform recommended', legend: [['#1D9E75','survived'],['#D85A30','perished']], ref: chart7Ref, small: true },
              { id: 'c8', title: 'Adjusted odds ratios â€” logistic regression', subtitle: 'sex effect dominates all predictors Â· both H1 & H2 survive full adjustment', legend: [], ref: chart8Ref, small: true },
          ...
          <div className="dashboard-footer">
            <span>Dataset: Seaborn built-in Titanic Â· N = 891 Â· missing age = 177 (MAR) Â· cabin excluded (MNAR, 77.1%)</span>
          </div>
        </div>
      ...
      <style jsx>{`
        * {
        ...
        /* â”€â”€ Chart card with enhanced hover â”€â”€ */
        .chart-card {
          position: relative;
          background: rgba(255,255,255,0.03);
